...
var articleRoute = require('../routes/article')(articleController);
...
function init(app) {
  ...
  app.get('/blog/admin/articles', articleRoute.list);
  app.get('/blog/admin/articles/new', articleRoute.show);
  app.post('/blog/admin/articles/new', articleRoute.create);
  app.get('/blog/admin/articles/:slug', articleRoute.retrieve);
  app.put('/blog/admin/articles/:slug', articleRoute.update);
