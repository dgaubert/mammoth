...
function init(app) {
  ...
  app.get('/blog/admin/captcha', captchaController.list);
  app.get('/blog/admin/captcha/new', captchaController.show);
  app.post('/blog/admin/captcha/new', captchaController.create);
  app.get('/blog/captcha/:captchaName', captchaController.retrieve);
  app.del('/blog/admin/captcha/:captchaName', captchaController.remove);
