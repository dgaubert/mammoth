...
function init(app) {
  ...
  app.delete('/blog/admin/articles/:slug/comments/:commentId', commentController.remove.bind(commentController));
  ...
  app.delete('/blog/admin/articles/:slug/pictures/:pictureName', pictureController.remove.bind(pictureController));
  ...
  app.delete('/blog/admin/captcha/:captchaName', captchaController.remove.bind(captchaController));
