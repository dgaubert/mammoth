module.exports = function (app, Article) {
  ...
  app.post('/blog/:slug/comment', newComment);
  ...
  app.get('/blog/admin/articles/:slug/comments', getComments);
  ...
  app.del('/blog/admin/articles/:slug/comments/:commentId', deleteComment);
