module.exports = function (app, Article) {
  ...
  app.get('/blog/admin/articles', getArticles);
   ...
   */
  var getNewArticle = function (req, res) {
  ...
  app.get('/blog/admin/articles/new', getNewArticle);
  ...
  app.post('/blog/admin/articles/new', newArticle);
  ...
  app.get('/blog/admin/articles/:slug', getArticle);
  ...
  app.put('/blog/admin/articles/:slug', updateArticle);
