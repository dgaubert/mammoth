module.exports = function (app, Article, Summary) {
  ...
  app.get('/blog', getSummary);
  app.get('/blog/:page', getSummary);
  app.get('/blog/category/:category', getSummary);
  app.get('/blog/category/:category/:page', getSummary);
  app.get('/blog/tag/:tag', getSummary);
  app.get('/blog/tag/:tag/:page', getSummary);
