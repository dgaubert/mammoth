module.exports = function (app, User) {
  ...
  app.get('/blog/admin/users/new', getNewUser);
  ...
  app.post('/blog/admin/users/new', newUser);
  ...
  app.get('/blog/admin/users', getUsers);
  app.get('/blog/admin/users/:username', getUser);
  ...
  app.put('/blog/admin/users/:username', updateUser);
