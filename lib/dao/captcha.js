...
CaptchaDao.prototype.save = function save(name, value, path, callback) {
...
CaptchaDao.prototype.read = function read(name, callback) {
...
CaptchaDao.prototype.find = function find(callback) {
  this.captchaModel
...
CaptchaDao.prototype.count = function count(callback) {
  this.captchaModel
...
CaptchaDao.prototype.findByValue = function findByValue(value, callback) {
  this.captchaModel
    .find({
...
CaptchaDao.prototype.remove = function remove(name, callback) {
  var gridStore = new GridStore(mongoose.connection.db, name, 'r', {
    'root': 'captchas',
    'content_type': 'image/png'
  });
