...
PictureController.prototype.retrieve = function retrieve(req, res, next) {
...
PictureController.prototype.create = function create(req, res, next) {
...
PictureController.prototype.remove = function remove(req, res, next) {
  var slug = req.params.slug ? req.params.slug[0] : null;
  var name = req.params.pictureName ? req.params.pictureName[0] : null;
