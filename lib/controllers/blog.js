...
BlogController.prototype.list = function (req, res, next) {
  ...
  this.blogService.list(page, category, tag, function listBlogDone(err, blog) {
    ...
    if (!blog.articles.length) return next(new Error ('No articles found'));
...
BlogController.prototype.retrieve = function (req, res, next) {
