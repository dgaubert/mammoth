...
CaptchaController.prototype.list = function list(req, res, next) {
...
CaptchaController.prototype.show = function show(req, res, next) {
...
CaptchaController.prototype.retrieve = function retrieve(req, res, next) {
...
CaptchaController.prototype.create = function create(req, res, next) {
...
CaptchaController.prototype.remove = function remove(req, res, next) {
  var name = req.params.captchaName;
