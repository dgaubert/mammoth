...
CommentController.prototype.create = function create(req, res, next) {
...
CommentController.prototype.list = function list(req, res, next) {
  var slug = req.params.slug ? req.params.slug[0] : null;
...
CommentController.prototype.remove = function remove(req, res, next) {
  var slug = req.params.slug ? req.params.slug[0] : null;
