...
var express = require('express'), // Web framework
    ...
    HomeRouter = require('./routes/home'), // Manage the home page
    BlogRouter = require('./routes/blog'), // Manage the blog
    CommentRouter = require('./routes/comment'), // Manage comments (blog)
    LoginRouter = require('./routes/login'), // Monitor admin section
    AdminRouter = require('./routes/admin'), // Manage admin page
    UserRouter = require('./routes/user'), // Manage user/s page (admin)
    ErrorRouter = require('./routes/error'), // Error handler
    ArticleRouter = require('./routes/article'), // Manage article/s page (admin)
    RssRouter = require('./routes/rss'),
    PictureRouter = require('./routes/picture'),
    Guard = require('./utils/guard'),
    ArticleService = require('./services/article-service'), // db model & service
    UserService = require('./services/user-service'),
    PictureService = require('./services/picture-service'); // db model & service
...
// Controllers
var home = new HomeRouter(ArticleService);
app.get('/', home.getHome);

var blog = new BlogRouter(ArticleService);
...
var comment = new CommentRouter(ArticleService);
...
var login = new LoginRouter(UserService);
...
var user = new UserRouter(UserService);
...
var article = new ArticleRouter(ArticleService, PictureService);
...
var picture = new PictureRouter(PictureService);
...
var rss = new RssRouter(ArticleService);
app.get('/blog/rss', rss.getFeed);

// Error middleware
var error = new ErrorRouter();
