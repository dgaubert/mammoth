...
var express = require('express'), // Web framework
    ...
    SummaryModel = require('./models/summary'), // db model & service
...
// Controllers
var home = new Home(SummaryModel);
app.get('/', home.getHome);

var blog = new Blog(ArticleModel, SummaryModel);
...
var cloud = new Cloud(SummaryModel);
