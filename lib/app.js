...
var express = require('express'), // Web framework
    ...
    ErrorHandler = require('./routes/error'), // Error handler
    ...
    PictureStore = require('./model/picture'); // db model & service
...
var picture = new Picture(PictureStore);
app.get('/blog/:slug/picture/:picture', picture.getPicture);
app.post('/blog/admin/articles/:slug/picture/new', picture.newPicture);
app.del('/blog/admin/articles/:slug/picture/:pictureId', picture.deletePicture);
