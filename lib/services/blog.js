...
BlogService.prototype = {
  '_getArticleWithExtraBlogInfo': function _getArticleWithExtraBlogInfo(slug, callback) {
    async.parallel({
  ...
  '_findSimilarArticles': function _findSimilarArticles(blog, callback) {
  ...
  'list': function list(page, category, tag, callback) {
    async.parallel({
